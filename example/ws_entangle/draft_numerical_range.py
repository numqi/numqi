...
def demo_PPT_numerical_range():
    ...
    z0 = numqi.entangle.get_ppt_numerical_range(op0, op1, num_theta=400)
...
def demo_2qubit_numerical_range():
    ...
    ret_ppt = numqi.entangle.get_ppt_numerical_range(op0, op1, dim=(dimA,dimB), num_theta=num_theta)
    ...
    fig,ax = plt.subplots()
    ax.plot(ret_ppt[:,0], ret_ppt[:,1], 'x', label=f'PPT')
