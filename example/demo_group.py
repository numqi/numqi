...
N0 = 4
# z0 = numqi.group.get_multiplicative_group_cayley_table(N0)
z0 = numqi.group.get_symmetric_group_cayley_table(N0)
# z0 = numqi.group.get_symmetric_group_cayley_table(N0, alternating=True)
# z0 = numqi.group.get_dihedral_group_cayley_table(N0)
# z0 = numqi.group.get_cyclic_group_cayley_table(N0)
# z0 = numqi.group.get_klein_four_group_cayley_table()
# z0 = numqi.group.get_quaternion_cayley_table()
z1 = numqi.group.cayley_table_to_left_regular_form(z0)
irrep_list = numqi.group.reduce_group_representation(z1)
